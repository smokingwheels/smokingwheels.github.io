...
Function try_complete_request% (c As Integer)
    ...
    Select Case client_method(c)
        ...
        Case METHOD_GET
            ...
            html$ = html$ + "<p>"
            html$ = html$ + " Dial a Cloud-Party 0473 429 901 <a href=" + Chr$(34) + "http://cloud-party.undo.it/index.php/s/QtGLoMng8C2HjM8" + Chr$(34) + ">Your name here  18th Upload/Download/Share </a> By SmokingWheels a QB64 based web site developer with a Cloud. "
            html$ = html$ + "</p>"
            ...
            html$ = html$ + "<embed type=" + Chr$(34) + "image/png" + Chr$(34) + "src=" + Chr$(34) + "http://cloud-party.undo.it/index.php/s/azn5rDckCDEjKrt/download/flyer jan 2023.png" + Chr$(34) + "width=" + Chr$(34) + "500" + Chr$(34) + "height=" + Chr$(34) + "500" + Chr$(34) + ">"
            html$ = html$ + "</EMBED>"
            html$ = html$ + "<embed type=" + Chr$(34) + "image/png" + Chr$(34) + "src=" + Chr$(34) + "http://cloud-party.undo.it/index.php/s/qTGbzPKnppwDwbr/download/Transpeed-Android-12-TV-Box-specs 2.png" + Chr$(34) + "width=" + Chr$(34) + "500" + Chr$(34) + "height=" + Chr$(34) + "500" + Chr$(34) + ">"
            html$ = html$ + "</EMBED>"
