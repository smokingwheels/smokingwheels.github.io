...
Function try_complete_request% (c As Integer)
    ...
    Select Case client_method(c)
        ...
        Case METHOD_GET
            ...
            html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.103:4747/" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "left" + Chr$(34) + " height = " + Chr$(34) + "120%" + Chr$(34) + " width = " + Chr$(34) + "75%" + Chr$(34) + ">" + "</iframe>"
            html$ = html$ + "</div>"
            html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
