...
Function try_complete_request% (c As Integer)
    ...
    Select Case client_method(c)
        ...
        Case METHOD_GET
            ...
            html$ = "<html><head></head><body>You requested a Cloud? <tt>"
            ...
            '            html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.20:3000/Crawler_p.html" + Chr$(34) + " style=" + Chr$(34) + "border:1px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "50%" + Chr$(34) + " width = " + Chr$(34) + "75%" + Chr$(34) + ">" + "</iframe>"
            '           html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.20:3000/IndexCreateLoaderQueue_p.html" + Chr$(34) + " style=" + Chr$(34) + "border:1px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "100%" + Chr$(34) + " width = " + Chr$(34) + "100%" + Chr$(34) + ">" + "</iframe>"
            '
            '         html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.20:3000/Status.html" + Chr$(34) + " style=" + Chr$(34) + "border:1px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "100%" + Chr$(34) + " width = " + Chr$(34) + "100%" + Chr$(34) + ">" + "</iframe>"
            '
            '       html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.20:3000/Performance_p.html" + Chr$(34) + " style=" + Chr$(34) + "border:1px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "100%" + Chr$(34) + " width = " + Chr$(34) + "100%" + Chr$(34) + ">" + "</iframe>"

            html$ = html$ + "<h2> Cloud-Party-Private </h2>"
            html$ = html$ + "<p>"
            html$ = html$ + " Dial a Cloud-Party-Private 0473 429 901 <a href=" + Chr$(34) + "http://192.168.1.53/index.php/s/QtGLoMng8C2HjM8?" + Chr$(34) + ">Your name here  Upload/Download/Share </a> By SmokingWheels a QB64 based web site developer with a Cloud. "
            html$ = html$ + "</p>"
            html$ = html$ + "<h2> Cloud-Party-Public </h2>"
            html$ = html$ + "<p>"
            html$ = html$ + " Dial a Cloud-Party-Public 0473 429 901 <a href=" + Chr$(34) + "http://cloudparty.evils.in/index.php/s/QtGLoMng8C2HjM8" + Chr$(34) + ">Your name here  18th Upload/Download/Share </a> By SmokingWheels a QB64 based web site developer with a Cloud. "
            html$ = html$ + "</p>"


            ' html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            'html$ = html$ + "<iframe src=" + Chr$(34) + "http://cloud-party.undo.it/index.php/s/azn5rDckCDEjKrt/download/flyer jan 2023.png" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "left" + Chr$(34) + " height = " + Chr$(34) + "75%" + Chr$(34) + " width = " + Chr$(34) + "75%" + Chr$(34) + ">" + "</iframe>"
            ' html$ = html$ + "</div>"

            html$ = html$ + "<embed type=" + Chr$(34) + "image/png" + Chr$(34) + "src=" + Chr$(34) + "http://cloudparty.evils.in/index.php/s/azn5rDckCDEjKrt/download/flyer jan 2023.png" + Chr$(34) + "width=" + Chr$(34) + "500" + Chr$(34) + "height=" + Chr$(34) + "500" + Chr$(34) + ">"
            html$ = html$ + "</EMBED>"
            html$ = html$ + "<embed type=" + Chr$(34) + "image/png" + Chr$(34) + "src=" + Chr$(34) + "http://cloudparty.evils.in/index.php/s/qTGbzPKnppwDwbr/download/Transpeed-Android-12-TV-Box-specs 2.png" + Chr$(34) + "width=" + Chr$(34) + "500" + Chr$(34) + "height=" + Chr$(34) + "500" + Chr$(34) + ">"
            html$ = html$ + "</EMBED>"
            html$ = html$ + "<embed type=" + Chr$(34) + "image/png" + Chr$(34) + "src=" + Chr$(34) + "http://cloudparty.evils.in/index.php/s/azn5rDckCDEjKrt/download/flyer jan 2023.png" + Chr$(34) + "width=" + Chr$(34) + "500" + Chr$(34) + "height=" + Chr$(34) + "500" + Chr$(34) + ">"
            html$ = html$ + "</EMBED>"
            html$ = html$ + "<embed type=" + Chr$(34) + "image/png" + Chr$(34) + "src=" + Chr$(34) + "https://www.facebook.com/smokingwheels1/posts/pfbid02XJwQZNmvdxyJGXP8zKXKqaY5iFQiKAA7yRbaFP3Xd9bFZUXBXrW6auQ9kditWyZZl?__cft__[0]=AZWuwwIk7xr6nAK7qbXjeFVkMK-vf-IMY902pOEWYGGDok18qX05Us8rMz9McmAMNATlIGFh-MKzZS9rHBbQVmUxtqQ6PoP1Mh8WQql37poKHw&__tn__=%2CO%2CP-R" + Chr$(34) + "width=" + Chr$(34) + "500" + Chr$(34) + "height=" + Chr$(34) + "500" + Chr$(34) + ">"
            html$ = html$ + "</EMBED>"


            '            html$ = html$ + "<embed type=" + Chr$(34) + "image/png" + Chr$(34) + "src=" + Chr$(34) + "http://192.168.1.53/index.php/s/QtGLoMng8C2HjM8?dir=undefined&path=%2FMusic&openfile=2410" + Chr$(34) + "width=" + Chr$(34) + "75%" + Chr$(34) + "height=" + Chr$(34) + "75%" + Chr$(34) + ">"
            '           html$ = html$ + "</EMBED>"

            html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.53:32400/web/index.html" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "100%" + Chr$(34) + " width = " + Chr$(34) + "100%" + Chr$(34) + ">" + "</iframe>"
            html$ = html$ + "</div>"

            html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            html$ = html$ + "<iframe src=" + Chr$(34) + "http://cloud-party.undo.it:32400/web/index.html" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "100%" + Chr$(34) + " width = " + Chr$(34) + "100%" + Chr$(34) + ">" + "</iframe>"
            html$ = html$ + "</div>"
            ...
            html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.112:4747/video?640x480/" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "100%" + Chr$(34) + " width = " + Chr$(34) + "100%" + Chr$(34) + ">" + "</iframe>"
            html$ = html$ + "</div>"


            html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            html$ = html$ + "<iframe src=" + Chr$(34) + "http://cloud-party.undo.it/index.php/s/QtGLoMng8C2HjM8?path=%2FVideo" + Chr$(34) + " id=" + Chr$(34) + "previewURL" + Chr$(34) + ">" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "right" + Chr$(34) + " height = " + Chr$(34) + "120%" + Chr$(34) + " width = " + Chr$(34) + "75%" + Chr$(34) + ">" + "</iframe>"
            html$ = html$ + "</div>"
            html$ = html$ + " <video width=" + Chr$(34) + "500px" + Chr$(34) + " height=" + Chr$(34) + "500px" + Chr$(34) + Chr$(34) + "controls=" + Chr$(34) + "controls" + Chr$(34) + "/>" + " <source src=" + Chr$(34) + "http://cloud-party.undo.it/index.php/apps/files/?dir=/Video&openfile=305" + Chr$(34) + " type=" + Chr$(34) + "video/mp4" + Chr$(34) + ">"



            '         ' html$ = html$ + ".box{"
            'html$ = html$ + "   float:left;"
            '  html$ = html$ + "     margin-right:20px;"
            ' html$ = html$ + "}"
            'html$ = html$ + ".clear{"
            ' html$ = html$ + "   clear:both;"
            'html$ = html$ + "}"
            '  html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            '           ' html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.112:4747/video?640x480/" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "25%" + Chr$(34) + " width = " + Chr$(34) + "25%" + Chr$(34) + ">" + "</iframe>"
            '           html$ = html$ + "</div>"
            '          html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            '         html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.100:4747/video?640x480/" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "25%" + Chr$(34) + " width = " + Chr$(34) + "25%" + Chr$(34) + ">" + "</iframe>"
            '        html$ = html$ + "</div>"
            '       html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            '      html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.112:4747/video?640x480/" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "25%" + Chr$(34) + " width = " + Chr$(34) + "25%" + Chr$(34) + ">" + "</iframe>"
            '     html$ = html$ + "</div>"
            ...
            html$ = html$ + "</div>"
            html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.100:4747/video?640x480/" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "100%" + Chr$(34) + " width = " + Chr$(34) + "100%" + Chr$(34) + ">" + "</iframe>"
            html$ = html$ + "</div>"
            '        html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            '       html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.103:4747/" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "100%" + Chr$(34) + " width = " + Chr$(34) + "100%" + Chr$(34) + ">" + "</iframe>"
            '      html$ = html$ + "</div>"
            '     html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            '    html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.103:4747/" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "100%" + Chr$(34) + " width = " + Chr$(34) + "100%" + Chr$(34) + ">" + "</iframe>"
            '   html$ = html$ + "</div>"
