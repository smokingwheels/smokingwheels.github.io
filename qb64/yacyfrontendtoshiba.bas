...
Function try_complete_request% (c As Integer)
    ...
    Select Case client_method(c)
        ...
        Case METHOD_GET
            ...
            html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.20:3000/ConfigHTCache_p.html" + Chr$(34) + " style=" + Chr$(34) + "border:1px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "center" + Chr$(34) + " height = " + Chr$(34) + "100%" + Chr$(34) + " width = " + Chr$(34) + "100%" + Chr$(34) + ">" + "</iframe>"
