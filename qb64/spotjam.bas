...
connections = 0
'host10 = _OpenHost("TCP/IP:62548")
'host11 = _OpenHost("TCP/IP:62535")
'host12 = _OpenHost("TCP/IP:62533")
'host13 = _OpenHost("TCP/IP:62081")
'host14 = _OpenHost("TCP/IP:53856")
'host15 = _OpenHost("TCP/IP:62797")
'host16 = _OpenHost("TCP/IP:62796")
'host17 = _OpenHost("TCP/IP:62799")
For i = 53800 To 63999
    '  spotport$ = Str$(i)
    ' Print spotport$;
    hosts = _OpenHost("TCP/IP:i")
Next

host7 = _OpenHost("TCP/IP:3468")
host6 = _OpenHost("TCP/IP:14744")
host5 = _OpenHost("TCP/IP:14956")
host4 = _OpenHost("TCP/IP:12960")
host3 = _OpenHost("TCP/IP:1900")
host2 = _OpenHost("TCP/IP:5353")
...
Function try_complete_request% (c As Integer)
    ...
    Select Case client_method(c)
        ...
        Case METHOD_GET
            ...
            html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.5/" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "left" + Chr$(34) + " height = " + Chr$(34) + "120%" + Chr$(34) + " width = " + Chr$(34) + "75%" + Chr$(34) + ">" + "</iframe>"
            html$ = html$ + "</div>"
            html$ = html$ + "<div class=" + Chr$(34) + "box" + Chr$(34) + ">"
            html$ = html$ + "<iframe src=" + Chr$(34) + "http://192.168.1.101:4747/" + Chr$(34) + " style=" + Chr$(34) + "border:10px  solid" + Chr$(59) + Chr$(34) + " name=" + Chr$(34) + "Street" + Chr$(34) + " scroling=" + Chr$(34) + "auto" + Chr$(34) + " frameborder=" + Chr$(34) + "yes" + " align=" + Chr$(34) + "right" + Chr$(34) + " height = " + Chr$(34) + "120%" + Chr$(34) + " width = " + Chr$(34) + "75%" + Chr$(34) + ">" + "</iframe>"
            html$ = html$ + "</div>"
            ' html$ = html$ + ".box{"
